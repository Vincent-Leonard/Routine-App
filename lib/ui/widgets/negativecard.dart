...
class NegativeCard extends StatefulWidget {
  final Habits habits;
  NegativeCard({this.habits});

  @override
  _NegativeCardState createState() => _NegativeCardState();
}

class _NegativeCardState extends State<NegativeCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      shape: Border(
          left: BorderSide(
              color: variable.isNotEmpty ? Colors.red : Colors.grey,
              width: 10)),
