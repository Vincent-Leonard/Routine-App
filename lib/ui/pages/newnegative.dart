...
class NewNegative extends StatefulWidget {
  static const String routeName = "NewNegative";
  @override
  _NewNegativeState createState() => _NewNegativeState();
}

class _NewNegativeState extends State<NewNegative> {
